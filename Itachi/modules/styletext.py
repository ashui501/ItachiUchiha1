...
WEEBIFY_HANDLER = CommandHandler("weebify", weebify, run_async=True)
BUBBLE_HANDLER = CommandHandler("bubble", bubble, run_async=True)
FBUBBLE_HANDLER = CommandHandler("fbubble", fbubble, run_async=True)
SQUARE_HANDLER = CommandHandler("square", square, run_async=True)
FSQUARE_HANDLER = CommandHandler("fsquare", fsquare, run_async=True)
BLUE_HANDLER = CommandHandler("blue", blue, run_async=True)
LATIN_HANDLER = CommandHandler("latin", latin, run_async=True)
LINED_HANDLER = CommandHandler("lined", lined, run_async=True)
