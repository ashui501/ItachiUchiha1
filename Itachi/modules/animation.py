...
KILL_HANDLER = CommandHandler("kill", kill, run_async=True)
LOVE_HANDLER = CommandHandler("love", love, run_async=True)
HACK_HANDLER = CommandHandler("hack", hack, run_async=True)
BOMBS_HANDLER = CommandHandler("bombs", bombs, run_async=True)
MOONANIMATION_HANDLER = CommandHandler("moon", moonanimation, run_async=True)
CLOCKANIMATION_HANDLER = CommandHandler(
    "clock", clockanimation, run_async=True
)
BLOCKANIMATION_HANDLER = CommandHandler(
    "block", blockanimation, run_async=True
)
EARTHANIMATION_HANDLER = CommandHandler(
